...
-- 3. Tabla Producto (con la nueva columna 'imagen_url')
CREATE TABLE Producto (
    ...
    talla VARCHAR(20),
    imagen_url VARCHAR(512) NULL, -- Columna para la URL de la imagen
    categoryid INT,
    brandid INT,
...
-- 4. Tabla Usuario (para la seguridad)
...
-- 6. Tabla de Unión Usuario_Rol (para la seguridad)
...
-- Inserción de datos en Producto (con la URL de la imagen)
INSERT INTO Producto (productname, price, stock, estado, talla, categoryid, brandid, imagen_url) VALUES
('Polera Deportiva Nike Dri-FIT', 89.99, 25, TRUE, 'M', 1, 1, 'https://i.postimg.cc/ZKJqP4yr/polera-nike-dri-fit.jpg'),
('Casaca Adidas Climalite', 119.90, 15, TRUE, 'L', 1, 2, 'https://i.postimg.cc/xdjfHRJf/adidas-climalite.jpg'),
('Leggings Under Armour HeatGear', 79.50, 30, TRUE, 'S', 1, 3, 'https://i.postimg.cc/wvy7yVZm/Leggings-Under-Armour-Heat-Gear.jpg'),
('Short Puma Training', 45.00, 50, TRUE, 'M', 1, 4, 'https://i.postimg.cc/tJbZK6Sc/short-puma-training.jpg'),
('Camiseta Umbro Teamwear', 35.99, 20, TRUE, 'L', 1, 5, 'https://i.postimg.cc/FzvdMSCm/Umbro-Teamwear.jpg'),
...
SELECT 
    productid, productname, imagen_url
FROM
    Producto;
SELECT * FROM usuario;
SELECT * FROM rol;
